...
class Cart(models.Model):
    ...
    product = models.ForeignKey(Product, on_delete=models.CASCADE)     #Each cart instance is associated with a single pet product. Similarly, the on_delete=models.CASCADE argument means that if the referenced Pet object is deleted, the corresponding Cart instances associated with that product will be deleted.
...
class Order(models.Model):
    ...
    pet = models.ForeignKey(Product, on_delete=models.CASCADE)
